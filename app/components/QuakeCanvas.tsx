...
export default function QuakeCanvas({
  ...
  // Shared data layer — polling / P2P fallback / last-known hydration all
  // live in the hook so the toon renderer gets identical behaviour.
  const { quakesRef, firstSeenRef } = useQuakes({
    region,
    minMag,
    onStatsChange,
  });
